  ...
  return (
    <section className="py-16">
      <div className="max-w-6xl mx-auto px-6">
        <div className="mb-8">
          <p className="text-xs uppercase tracking-widest text-brand-500 mb-2">Continue Reading</p>
            ...
            <motion.div key={l.to} initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.05 }}>
              <Link href={l.to} className="glow-card block p-5 group h-full">
                <div className="flex items-start justify-between gap-3 mb-2">
                  ...
                  <ArrowUpRight size={14} className="text-ink-dim group-hover:text-brand-500" />
                </div>
